...
Emails are sent to the user who configured the tool, and can also be sent to any additional provided emails.

## Notes

- May not work with custom workflows where the release state is named differently.
- The release export trigger may take a few minutes.
